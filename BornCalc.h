...
complex<double> BornForPoint  (Point3D_t
 rEmitter, Point3D_t
 rReceiver);

complex<double> GreenFunction (Point3D_t
 rEmitter, Point3D_t
 rReceiver);

complex<double> PressureI_    (Point3D_t
 rReceiver);

double          SoundSpeed    (Point3D_t
 rEmitter);

double          d_Slowness    (Point3D_t
 r);
